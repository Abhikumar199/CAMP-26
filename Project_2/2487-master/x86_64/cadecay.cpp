...
#define channel_flow _ml->template fpfield<2>(_iml)
#define channel_flow_columnindex 2
#define B _ml->template fpfield<3>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"channel_flow"} /* 2 */,
                                       _nrn_mechanism_field<double>{"B"} /* 3 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cad /home/rj/projects/temp/temp/CAMP/project_3.1/2487-master/cadecay.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double FARADAY = 96154;
static int _reset;
static const char *modelname = "Calcium decay";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/rj/projects/temp/temp/CAMP/project_3.1/2487-master/cadecay.mod";
