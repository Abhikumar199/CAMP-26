...
#define _f_rates _f_rates__kfasttab 
...
#define k _ml->template fpfield<3>(_iml)
...
#define Dk _ml->template fpfield<6>(_iml)
...
#define ninf ninf_kfasttab
 double ninf = 0;
#define usetable usetable_kfasttab
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 {"gkbar_kfasttab", 0, 1e+09},
 {"usetable_kfasttab", 0, 1},
 {0, 0, 0}
};
 ...
 {"usetable_kfasttab", &usetable_kfasttab},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kfasttab /Users/shraddhapathak/Downloads/Neuron26-main/2487-master/kfasttab.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double *_t_ninf;
 static double *_t_kinf;
 static double *_t_ntau;
 static double *_t_ktau;
static int _reset;
static const char *modelname = "HH fast potassium channel";
...
/*CVODE*/
 ...
 kinf = _t_kinf[_i] + _theta*(_t_kinf[_i+1] - _t_kinf[_i]);
 ntau = _t_ntau[_i] + _theta*(_t_ntau[_i+1] - _t_ntau[_i]);
 ktau = _t_ktau[_i] + _theta*(_t_ktau[_i+1] - _t_ktau[_i]);
 }

 
static int  _f_rates (  double _lv ) {
   ninf = 1.0 / ( 1.0 + exp ( - ( _lv + 19.0 ) / 10.0 ) ) ;
   kinf = 0.135 + 0.865 / ( 1.0 + exp ( ( _lv + 14.0 ) / 6.5 ) ) ;
   ntau = 0.45 + 2.6 * exp ( - ( ( _lv + 40.0 ) / 38.0 ) * ( ( _lv + 40.0 ) / 38.0 ) ) ;
   ktau = 50.0 ;
    return 0; }
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 43 in file kfasttab.mod:\nBREAKPOINT {\n";
...
static void _initlists() {
 ...
 _slist1[1] = {k_columnindex, 0};  _dlist1[1] = {Dk_columnindex, 0};
   _t_ninf = makevector(201*sizeof(double));
   _t_kinf = makevector(201*sizeof(double));
   _t_ntau = makevector(201*sizeof(double));
   _t_ktau = makevector(201*sizeof(double));
_first = 0;
}

#if NMODL_TEXT
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/shraddhapathak/Downloads/Neuron26-main/2487-master/kfasttab.mod";
    const char* nmodl_file_text = 
  "TITLE HH fast potassium channel\n"
  ...
  "    ntau = 0.45 + 2.6 * exp(-((v + 40)/38)*((v + 40)/38))\n"
  "    ktau = 50\n"
  "}\n"
  ;
