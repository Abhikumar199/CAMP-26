...
#define _f_rates _f_rates__kslowtab 
...
#define ninf ninf_kslowtab
 double ninf = 0;
#define usetable usetable_kslowtab
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 {"gkbar_kslowtab", 0, 1e+09},
 {"usetable_kslowtab", 0, 1},
 {0, 0, 0}
};
 ...
 {"usetable_kslowtab", &usetable_kslowtab},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kslowtab /Users/shraddhapathak/Downloads/Neuron26-main/2487-master/kslowtab.mod\n");
...
static int _reset;
static const char *modelname = "HH slow potassium channel";
...
static int  _f_rates (  double _lv ) {
   ...
   ntau = 1.9 + 10.5 * exp ( - ( ( _lv + 40.0 ) / 38.0 ) * ( ( _lv + 40.0 ) / 38.0 ) ) ;
   ktau = 200.0 ;
    return 0; }
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 43 in file kslowtab.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/shraddhapathak/Downloads/Neuron26-main/2487-master/kslowtab.mod";
